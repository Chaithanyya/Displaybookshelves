...
public class TC_003_Giftcards extends BaseClass
{
	...
	@Test(priority=6,dataProvider="dp",dataProviderClass=DataProviders.class,groups= {"regression"})
	...
	@Test(priority=7,dataProvider ="dp",dataProviderClass=DataProviders.class,groups= {"regression"})
	...
	@Test(priority=8,dataProvider ="dp",dataProviderClass=DataProviders.class,groups= {"regression"})
